// build.rs — Tauri 构建 + 将 speech-sdk 下载的原生库复制到 exe 同目录。
// 否则运行时报错：找不到 Microsoft.CognitiveServices.Speech.core 原生库。
//
// 桌面三平台：
...
fn copy_native_libs() {
    ...
    // OUT_DIR = target/<profile>/build/tfp-desktop-HASH/out → 向上 3 级到 profile 目录

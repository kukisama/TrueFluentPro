...
pub enum ResultReason {
    ...
    SynthesizingAudioCompleted = ffi::ResultReason_SynthesizingAudioCompleted,
}
...
impl From<ffi::Result_Reason> for ResultReason {
    fn from(value: ffi::Result_Reason) -> Self {
        match value {
            ...
            ffi::ResultReason_SynthesizingAudioCompleted => ResultReason::SynthesizingAudioCompleted,
...
pub enum CancellationReason {
    ...
    CancelledByUser = ffi::CancellationReason_CancelledByUser,
}
...
impl From<ffi::Result_CancellationReason> for CancellationReason {
    fn from(value: ffi::Result_CancellationReason) -> Self {
        match value {
            ...
            ffi::CancellationReason_CancelledByUser => CancellationReason::CancelledByUser,
...
#[repr(i32)]
pub enum PropertyId {
    SpeechServiceConnectionKey = ffi::PropertyId_SpeechServiceConnection_Key,
    SpeechServiceConnectionEndpoint = ffi::PropertyId_SpeechServiceConnection_Endpoint,
    SpeechServiceConnectionRegion = ffi::PropertyId_SpeechServiceConnection_Region,
    SpeechServiceAuthorizationToken = ffi::PropertyId_SpeechServiceAuthorization_Token,
    SpeechServiceConnectionEndpointId = ffi::PropertyId_SpeechServiceConnection_EndpointId,
    SpeechServiceConnectionTranslationToLanguages = ffi::PropertyId_SpeechServiceConnection_TranslationToLanguages,
    SpeechServiceConnectionTranslationVoice = ffi::PropertyId_SpeechServiceConnection_TranslationVoice,
    SpeechServiceConnectionRecoLanguage = ffi::PropertyId_SpeechServiceConnection_RecoLanguage,
    SpeechServiceResponseJsonErrorDetails = ffi::PropertyId_SpeechServiceResponse_JsonErrorDetails,
    SpeechServiceConnectionSynthLanguage = ffi::PropertyId_SpeechServiceConnection_SynthLanguage,
    SpeechServiceConnectionSynthVoice = ffi::PropertyId_SpeechServiceConnection_SynthVoice,
}
